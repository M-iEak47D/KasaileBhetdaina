...
export default function Doubts(){
   ...
   let History = useHistory();
    ...
    const [previewImage, setmyImage] = useState();
                                ...
                                <div className="row">
                                    <div className="col-md-6 col-12">
                                        <div className="img-container">
                                            <img id="target" src={(previewImage == null ? require('../assets/images/addPhoto.png') : {image})} className="img-fluid" onClick={clickHandle}/>
                                        </div>
                                    </div>  
                                    <div className="col-md-6 col-12">

...
@push('scripts')
    ...
    <script>
        $(document).on('submit', '#eduForm', function (e) {
            ...
            var myUrl = "{{ route('admin.store.note') }}";
    ...
    <script>
        $(document).on("click", ".btn-edit-row", function (e) {
            ...
            var tempEditUrl = "{{ route('admin.edit.note', ':id') }}";
    ...
    <script>
        $(document).on('submit', '#eduFormUpdate', function (e) {
            ...
            var myUrl = "{{ route('admin.update.note') }}";
    ...
    <script>
        $(document).on('click', '.btn-chnage-status', function (e) {
            e.preventDefault();
            var id = $(this).attr("data-id");
            var tempDeleteUrl = "{{ route('admin.changestatus.note', ':id') }}";
    ...
    <script>
        $(document).on('click', '.btn-delete-row', function (e) {
            e.preventDefault();
            var id = $(this).attr("data-id");
            var tempDeleteUrl = "{{ route('admin.delete.note', ':id') }}";
            tempDeleteUrl = tempDeleteUrl.replace(':id', id);
